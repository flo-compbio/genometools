# -*- coding: utf-8 -*-
#
# GenomeTools documentation build configuration file, created by
...
MOCK_MODULES = ['cython','xlmhg','plotly']
...
htmlhelp_basename = 'GenomeToolsdoc'
...
latex_documents = [
  (master_doc, 'GenomeTools.tex', u'GenomeTools Documentation',
...
man_pages = [
    (master_doc, 'genometools', u'GenomeTools Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'GenomeTools', u'GenomeTools Documentation',
   author, 'GenomeTools', 'One line description of project.',
   'Miscellaneous'),
]
